...
describe('POST /files', () => {
    ...
    it('POST /files creates a folder at the root', (done) => {
        ...
        chai.request('http://localhost:5000')
		    ...
		    console.log("This the resFile: ", resFile);
			...
			console.log("docFile: ", docFile);
			    ...
			    console.log('This the refile.id: ', resFile._id);
			    console.log(`docfile id: ${docFile._id.toString()}`);
				console.log(`resfile: ${resFile.id}`);
